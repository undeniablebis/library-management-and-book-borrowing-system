...
public class PageButtonPanel extends JPanel {
	...
	private List<JComponent> currentShownPageButtons;
	private ActionListener pageActionListener;
	
	// All page number buttons are displayed in this JPanel
	private JPanel jpnlCurrentShownPageButtons;
	
	// Previous Page button
	private JButton jbtnPreviousPage;
	
	// Next Page button
	private JButton jbtnNextPage;
